...
# Veri setini yukleme
veri <- read.csv(file = "Data_Son.csv", head = TRUE, sep=";")

print(veri)

names(veri) <- gsub("\\.", ",", names(veri))
print(veri)

# veriyi BLK sütununa göre sıralama
blok_data <- veri[order(veri$SAL, decreasing = TRUE),]
